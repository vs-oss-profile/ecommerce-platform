...
const _nav = [
  ...
  },
  {
    ...
    name: 'Inventory',
    to: '/',
    icon: <MdOutlineInventory className="nav-icon" />,
    items: [
      {
        component: CNavItem,
        name: 'View',
  ...
  },
  {
    ...
    name: 'Offers',
    to: '/',
    icon: <MdOutlineLocalOffer className="nav-icon" />,
    items: [
      {
        component: CNavItem,
        name: 'Add',
  ...
  },
  {
    ...
    name: 'Reviews',
    to: '/',
    icon: <MdOutlineRateReview className="nav-icon" />,
    items: [
      {
        component: CNavItem,
        name: 'View',
