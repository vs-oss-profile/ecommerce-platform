    ...
    return (
      <div className="container mx-auto px-8 py-32 text-center">
        ...
        >
          ...
          <Link to="/" className="btn btn-primary btn-lg rounded-full px-12">
            Start Shopping
          </Link>
        </motion.div>
      </div>
  ...
  return (
    <div className="container mx-auto px-8 py-16">
      <h1 className="text-5xl font-black mb-12 uppercase tracking-tight">
        Shopping Bag{" "}
        <span className="text-primary opacity-30">({totalItems})</span>
      </h1>
